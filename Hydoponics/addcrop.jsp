...
<html>
    ...
    <form enctype="multipart/form-data" action="addcropcode.jsp" method="post">
        <br><br><br>
        <center>
...
<table width="1076" border="0" align="center"  style="color:black">
  <tr bgcolor="#65D6CF">
    ...
    <td width="146"><div align="center"><strong>Soil Type</strong></div></td>
    <td width="144"><div align="center"><strong>ID</strong></div></td>
	<td width="92"><div align="center"><strong>Image</strong></div></td>
  <td width="132"><div align="center"><strong>Added by</strong></div></td>
    <td width="67">&nbsp;</td>
  </tr>
