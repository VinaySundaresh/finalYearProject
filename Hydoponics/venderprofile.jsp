...
<br />
<br />
<p align="center" style="color:white;font-weight:bold;"><strong>My  Profile </strong></p>
...
<% 
 ...
 rst=stmt.executeQuery("select * from vender where email='"+session.getAttribute("vuser")+"' ");
  if(rst.next()){
  ...
  <tr style=" border-radius: 14px;" bordercolor="#F0F0F0" bgcolor="#CCCCFF">
    <td align="center" width="auto"><p align="center" class="style1"><strong>Name </strong>:<%= rst.getString(1) %></p>
      ...
      <p align="center" class="style1"><strong>gender:</strong><%= rst.getString(3) %></p>
	   <p align="center" class="style1"><strong>Email:</strong><%= rst.getString(4) %></p>
      <p align="center" class="style1"><strong>Address</strong>:<%= rst.getString(5) %></p>
