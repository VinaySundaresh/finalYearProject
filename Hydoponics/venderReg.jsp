...
<div align="center" class="style1">Vender Registration page</div>
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1" align="center">
    ...
    <tr>
      <td>Email</td>
      <td><input type="email" name="f4" /></td>
    </tr>
    <tr>
      <td>Address</td>
      <td><textarea name="f5"></textarea></td>
    </tr>
    <tr>
      <td>password</td>
...
try{
int x=stmt.executeUpdate("insert into vender(name,phone,gender,email,address,password) value('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"')");
if(x!=0){
%>
<script>
